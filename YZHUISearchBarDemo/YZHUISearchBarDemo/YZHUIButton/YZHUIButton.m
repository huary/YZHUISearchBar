...
-(void)_layoutImageTitleView
{
    ...
    if (self.requestImageSizeBlock) {
        imageSize = self.requestImageSizeBlock(imageSize);
    }
    
    CGSize titleSize = self.titleLabel.frame.size;
    if (self.requestTitleSizeBlock) {
        titleSize = self.requestTitleSizeBlock(titleSize);
    }
