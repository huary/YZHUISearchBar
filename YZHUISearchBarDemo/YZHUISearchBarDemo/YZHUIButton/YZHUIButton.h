...
typedef CGSize(^YZHUIButtonRequestSizeBlock)(CGSize originSize);
...
/* <#注释#> */
@property (nonatomic, copy) YZHUIButtonRequestSizeBlock requestImageSizeBlock;

/* <#注释#> */
@property (nonatomic, copy) YZHUIButtonRequestSizeBlock requestTitleSizeBlock;
